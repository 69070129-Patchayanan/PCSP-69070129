...
```text
ข้อนี้ให้ใช้พื้นที่ที่น้ำหมึกแผ่ขยาย เพื่อคำนวณว่าคนที่ร้องเรียนมาจะถูกน้ำท่วมในวินาทีที่เท่าไหร่
Input:
บรรทัดแรกรับตัวแปร S แทนพื้นที่ที่น้ำหมึกแผ่ขยายต่อ 1 วิ และตัวแปร N แทนจำนวนคนที่ร้องเรียน ในบรรทัดเดียว บรรทัดต่อมารับค่าตามจำนวนคนที่ร้องเรียน เป็นพิกัดของบ้านของคนที่ร้องเรียน 
Output:
แสดงค่าว่าน้ำจะท่วมบ้านของคนที่ร้องเรียนทั้งหมดวินาทีที่เท่าไหร่
Constraints:
ข้อนี้ต้องคิดหาสูตรเอง ต้องนึกภาพให้ออก โดยใช้ค่า pi ที่เขากำหนดมาให้ด้วย และ output ต้องปัดขึ้น
...
```text
Step1: อ่านค่าพื้นที่น้ำหมึกที่แผขยาย และจำนวนคนที่ร้องเรียน โดยใช้.spilt() เพื่อรับค่าในบรรทัดเดียว
Step2: ใช้ for in range(คนที่ร้องเรียน) รับค่าพิกัดบ้านของคนที่ร้องเรียนมาโดยใช้ .spilt() แยก Xi,Yi 
Step3: คิดหาสูตรในการหาวินาทีที่น้ำจะท่วมบ้านของคนที่ร้องเรียน
Step4: แสดงผลออกมาโดยใช้ f string ปัดเศษ
```
...
```text
คล้ายคลึงกับแผนแรกในส่วนของการรับ input แต่ในเรื่องของสูตร ตอนแรกคิดแล้วแต่มันใช้ไม่ได้ เลยไปลองถามเพื่อน ให้เพื่อนอธิบายว่ามันเป็นยังไงให้ฟัง และตอนแสดงผลลองใช้ f string ปัดเศษแต่มันไม่ได้ เลยไปค้นหาข้อมูลและใช้ math.ceil เพื่อปัดขึ้นเสมอ
```
...
```text
เพื่อดูว่าการคำนวณพื้นที่ที่เขียนถูกต้อง
```
...
```text
เพราะลองตรวจการคำนวณค่าจำนวนมากและการปัดขึ้น
```
...
```text
กรณีที่เวลาท่วมเป็นจำนวนเต็มพอดี
```
...
```text
อธิบายว่าโจทย์ข้อนี้ควรทำยังไงกันแน่ ช่วยแนะแนวทาง
```

คุณยังทำอะไรด้วยตนเอง

```text
ลองเขียนสูตรเองจากการที่เพื่อนอธิบาย
```
