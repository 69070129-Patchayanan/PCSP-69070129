...
```text
โจทย์ข้อนี้ให้รับคำสั่งตามจำนวน N ครั้ง + จะ เพิ่ม 10 - จะลด5 ให้แสดงผลรวมตามคำสั่ง

Input:
บรรทัดแรกรับค่าจำนวนการกระทำ จากนั้นรับค่าคำสั่งตามจำนวนค่าการกระทำ

Output:
แสดงผลรวมจากคำสั่งทั้งหมด

Constraints:
ข้อนี้ใช้ for in range เพื่อรับค่าทั้งหมด N ครั้ง
```
...
```text
Step1: รับ input จำนวนคำสั่ง 
Step2: เขียน for in range ของจำนวนคำสั่ง และรับ input คำสั่งตามจำนวนคำสั่ง
Step3: สร้างตัวแปร total
Step4: ตั้งเงื่อนไขว่าถ้า คำสั่งเป็น + ให้ total + 10 ส่วนถ้าคำสั่งเป็นลบให้ total + -5
Step5: แสดงผลของ total ออกมา
```
...
```text
เหมือนกับแผนแรก ใช้ for in range รับคำสั่งตามจำนวนคำสั่ง สามารถรับคะแนนตามคำสั่ง หาผลรวมทั้งหมด และแสดงผลออกมาได้
```
...
```text
ทดสอบว่าถ้าคำสั่งเป็น - หมด output จะติดลบจริงมั้ย
```
...
```text
ลองทดสอบเมื่อ จำนวนคำสั่งมีแค่ 1
```
