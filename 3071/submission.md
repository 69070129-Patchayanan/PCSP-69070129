...
```text
โจทย์ให้นับจำนวนในช่วง A ถึง B ที่หารด้วย d แล้วเหลือเศษ r

Input:
บรรทัดแรกรับจำนวนนับ A บรรทักที่สองรับจำนวนนับ B บรรทัดที่สามรับจำนวนนับ d ที่ต้องทำไปหารกับจำนวนนับในช่วง A ถึง B บรรทัดที่สี่รับจำนวนนับ r หรือคือเศษที่เมื่อจำนวนนับในช่วง A ถึง B หารด้วย d แล้วจะเหลือเศษเท่านี้

Output:
แสดงผลที่นับจำนวนที่หารด้วย d แล้วเหลือเศษ r

Constraints:
ข้อนี้ต้องใช้ความรู้เรื่อง for loop และใช้ mod เมื่อหาว่าแต่ล้ะตัวได้เศษเท่าไหร่
```
...
```text
Step 1: รับ Input numA(จำนวนนับ A), numB(จำนวนนับ B), devided(ตัวหาร) และ remainder(เศษ)
Step 2: นำไปเข้า for loop เพื่อนำจำนวนนับตั้งแต่ A ถึง B โดยใช้ตัวแปร i
Step 3: สร้างตัวแปร d เก็บค่าที่ i mod กับ d
Step4: สร้างตัวแปร total และนับค่า d ที่เท่ากับ r
```
...
```text
ทำเหมือนกับแผนแรกที่วางไว้ ใช้ for loop และ mod ตรวจดูว่าได้เศษเท่านี้ และนับออกมา
```
...
```text
ดูว่าการนับจำนวนที่ตรงเงื่อนไขแบบไม่มากเกินไปจะทำงานถูกต้อง
